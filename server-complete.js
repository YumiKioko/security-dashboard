...
function getSecurityData() {
    return {
        ...
        compliance: {
            iso27001: { score: 82, controls: 114, status: 'Active', lastAudit: '2024-01-10' },
            nist: { score: 78, functions: 23, status: 'In Progress', lastAudit: '2024-01-08' },
            gdpr: { score: 91, status: 'Compliant', lastAudit: '2024-01-12' },
            soc2: { score: 85, status: 'Compliant', lastAudit: '2024-01-05' }
        },
        infrastructure: {
            servers: [
        ...
        reports: {
            ...
            scheduled: 3,
            recent: [
                { id: 'RPT-001', name: 'Weekly Security Overview', date: '2024-01-15', status: 'completed', type: 'security' },
                { id: 'RPT-002', name: 'Compliance Audit Report', date: '2024-01-14', status: 'completed', type: 'compliance' },
                { id: 'RPT-003', name: 'Incident Summary Q1', date: '2024-01-13', status: 'pending', type: 'incidents' },
                { id: 'RPT-004', name: 'Infrastructure Health', date: '2024-01-12', status: 'completed', type: 'infrastructure' }
            ]
        }
    };
}

// API endpoints for all sections
